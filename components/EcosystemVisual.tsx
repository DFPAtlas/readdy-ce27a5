...
const projectNodes: ProjectNode[] = [
  ...
  { id: 'homora', name: 'Homora', sector: 'Smart Home', status: 'Concept Development', description: 'Smart-home platform and business ecosystem for monitoring, device support, third-party installation guidance and connected-home management.', capabilities: ['Smart Home', 'Monitoring', 'Support', 'Devices', 'Installation', 'Ecosystem'], icon: 'ri-home-wifi-line', color: '#7C3AED', angle: 80, distance: 160 },
